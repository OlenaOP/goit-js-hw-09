      ...
      buttonStart.addEventListener('click', () => {
        ...
        timerId = setInterval(() => {
          ...
          if (difference < 1000) {
            ...
            daysTimer.textContent = addZero(convertMs(difference).days);
            hoursTimer.textContent = addZero(convertMs(difference).hours);
            minutesTimer.textContent = addZero(convertMs(difference).minutes);
            secondsTimer.textContent = addZero(convertMs(difference).seconds);
